...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        if auth_principal.principal_id:
            ...
            assertions.assert_valid(assignment.teacher_id==auth_principal.teacher_id,'Wrong teacher')
    ...
    def get_assignments_by_teacher(cls,teacher_id):
        return cls.filter(cls.teacher_id==teacher_id,cls.state in [AssignmentStateEnum.GRADED,AssignmentStateEnum.SUBMITTED]).all()
